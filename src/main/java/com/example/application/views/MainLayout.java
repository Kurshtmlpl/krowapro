...
import com.example.application.views.swiftup.SwiftupView;
import com.example.application.views.ttmdocumentupload.TtmdocumentuploadView;
...
public class MainLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Swiftup", SwiftupView.class, "la la-map-signs"));
        nav.addItem(new AppNavItem("Ttmdocumentupload", TtmdocumentuploadView.class, "la la-text-width"));
